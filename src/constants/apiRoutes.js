// Base URLs
export const BASE_URL = 'https://:region.api.battle.net';
...
// Character Profile
export const CHARACTER = `${BASE_URL}/wow/character/:realm/:characterName`;
...
// Data Resources
export const DATA_REALMS = `${BASE_URL}/wow/realm/status`;
